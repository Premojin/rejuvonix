...
|---|---|---|
| `encounters` | EMBERFLOW-OWNED / OWNER REVIEW REQUIRED | Clinical encounter narratives must not be Rejuvonix records. |
| `treatment_plans` | EMBERFLOW-OWNED / OWNER REVIEW REQUIRED | Treatment decisions belong to the regulated provider system. |
