  ...
  return <main>
    ...
    <section className="compounded-section compounded-section-v6" id="compounded">
      ...
      <div className="glance-grid glance-grid-v6">
        <a className="glance-card semaglutide glance-card-v6" href={MAIN_GLP_INTAKE_URL}><p className="pill-label">Compounded option</p><div className="glance-visual-zone"><img className="glance-product-vial" src="/v6/semaglutide-2.5mg-ml.png" alt="Semaglutide compounded medication vial"/><div className="glance-number">01</div></div><div className="glance-content"><h3>Semaglutide</h3><p className="glance-sub">Acts on the GLP-1 receptor.</p><dl><div><dt>Typical format</dt><dd>Injection*</dd></div><div><dt>Schedule</dt><dd>Set by provider</dd></div><div><dt>Clinical review</dt><dd>Required</dd></div><div><dt>FDA status</dt><dd>Not FDA approved</dd></div></dl><span className="glance-assessment-cta">Start assessment <b>→</b></span></div></a>
        <a className="glance-card tirzepatide glance-card-v6" href={MAIN_GLP_INTAKE_URL}><p className="pill-label">Compounded option</p><div className="glance-visual-zone"><img className="glance-product-vial" src="/v6/tirzepatide-5mg-0.5ml.png" alt="Tirzepatide compounded medication vial"/><div className="glance-number">02</div></div><div className="glance-content"><h3>Tirzepatide</h3><p className="glance-sub">Acts on the GIP and GLP-1 receptors.</p><dl><div><dt>Typical format</dt><dd>Injection*</dd></div><div><dt>Schedule</dt><dd>Set by provider</dd></div><div><dt>Clinical review</dt><dd>Required</dd></div><div><dt>FDA status</dt><dd>Not FDA approved</dd></div></dl><span className="glance-assessment-cta">Start assessment <b>→</b></span></div></a>
        <a className="glance-card microdose glance-card-v6" href={MAIN_GLP_INTAKE_URL}><p className="pill-label">Compounded option</p><div className="glance-visual-zone"><img className="glance-product-vial" src="/v6/glp1-microdose-500mcg-ml.png" alt="GLP-1 Microdose compounded medication vial"/><div className="glance-number">03</div></div><div className="glance-content"><h3>GLP-1 Microdose</h3><p className="glance-sub">Lower-dose GLP-1 pathway considered only after provider review.</p><dl><div><dt>Typical format</dt><dd>Injection*</dd></div><div><dt>Schedule</dt><dd>Set by provider</dd></div><div><dt>Clinical review</dt><dd>Required</dd></div><div><dt>FDA status</dt><dd>Not FDA approved</dd></div></dl><span className="glance-assessment-cta">Start assessment <b>→</b></span></div></a>
