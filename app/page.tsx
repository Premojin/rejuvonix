  ...
  return <main>
    ...
    <section className="compounded-section" id="compounded">
      ...
      <div className="glance-grid">
        <article className="glance-card semaglutide"><div className="glance-silhouette-wrap homepage-vial-silhouette" aria-hidden="true"><img className="glance-silhouette" src="/homepage-semaglutide-silhouette.png" alt="" /><span className="glance-silhouette-label">SEMAGLUTIDE<small>COMPOUNDED · Rx</small></span></div><div className="glance-content"><div className="glance-number">01</div><p className="pill-label">Compounded option</p><h3>Semaglutide</h3><p className="glance-sub">Acts on the GLP-1 receptor.</p><dl><div><dt>Typical format</dt><dd>Injection*</dd></div><div><dt>Schedule</dt><dd>Set by provider</dd></div><div><dt>Clinical review</dt><dd>Required</dd></div><div><dt>FDA status</dt><dd>Not FDA approved</dd></div></dl><button onClick={openQuiz}>Check eligibility <span>→</span></button></div></article>
        <article className="glance-card tirzepatide"><div className="glance-silhouette-wrap homepage-vial-silhouette" aria-hidden="true"><img className="glance-silhouette" src="/homepage-tirzepatide-silhouette.png" alt="" /><span className="glance-silhouette-label">TIRZEPATIDE<small>COMPOUNDED · Rx</small></span></div><div className="glance-content"><div className="glance-number">02</div><p className="pill-label">Compounded option</p><h3>Tirzepatide</h3><p className="glance-sub">Acts on the GIP and GLP-1 receptors.</p><dl><div><dt>Typical format</dt><dd>Injection*</dd></div><div><dt>Schedule</dt><dd>Set by provider</dd></div><div><dt>Clinical review</dt><dd>Required</dd></div><div><dt>FDA status</dt><dd>Not FDA approved</dd></div></dl><button onClick={openQuiz}>Check eligibility <span>→</span></button></div></article>
