...
const wellnessPrograms = [
  {number:"01", name:"Weight loss", kicker:"Metabolic confidence", headline:"Feel lighter. Move forward with confidence.", copy:"Provider-guided care built around your health history, goals and daily routine.", image:"/program-weight-loss-concern.webp", alt:"A woman thoughtfully considering her weight and personal health goals", position:"right bottom", visualClass:"silhouette weight-loss-figure", moment:"Momentum", reassurance:"Care that meets you where you are"},
  ...
  return <main>
    ...
    <header className="site-header program-header">
      ...
      <nav className={`nav-links ${menuOpen ? "open" : ""}`} aria-label="Primary navigation">
        <span className="nav-menu-group goals-menu"><a href="/goals">Your Goals</a><GoalMegaMenu/></span><a href="#membership">Membership</a><span className="nav-menu-group"><a href="/support">Resource Center</a><span className="nav-dropdown"><a href="/how-it-works">How it works</a><a href="/support">Support</a><a href="/faq">FAQs</a><a href="/safety">Safety</a></span></span><span className="nav-menu-group"><a href="/how-it-works">About Us</a><span className="nav-dropdown"><a href="/how-it-works">Our approach</a><a href="/support">Our care model</a><a href="/safety">Clinical standards</a></span></span>
      </nav>
    ...
    <section className="program-hero" id="top">
      <div className="program-hero-copy">
        ...
        <h1>Personalized care for how you want to live.</h1>
        <p>Explore online pathways for weight loss, performance, sexual health, hair restoration and skin restoration, with licensed-provider review where clinical care is involved.</p>
    ...
    <section className="bmi-section" aria-labelledby="bmi-title">
      ...
      <div className="bmi-card">
        ...
        <div className="bmi-result digital-bmi" aria-live="polite"><div className="digital-readout"><span>Estimated BMI</span><strong>{bmiResult.value > 0 ? bmiResult.value.toFixed(1) : "—"}</strong><em>{bmiResult.category}</em></div><div className="bmi-meter" aria-hidden="true"><div className="bmi-track"><span className="bmi-marker" style={{left:`${bmiResult.marker}%`}}></span></div><div className="bmi-labels"><span>15</span><span>20</span><span>25</span><span>30</span><span>35</span><span>40+</span></div></div><div className="bmi-key" aria-label="BMI scale color key"><strong>Scale key</strong><ul><li><i className="bmi-key-low" aria-hidden="true"></i><span>Below range<br/><small>Under 18.5</small></span></li><li><i className="bmi-key-standard" aria-hidden="true"></i><span>Standard range<br/><small>18.5–24.9</small></span></li><li><i className="bmi-key-above" aria-hidden="true"></i><span>Above range<br/><small>25–29.9</small></span></li><li><i className="bmi-key-high" aria-hidden="true"></i><span>Higher range<br/><small>30–34.9</small></span></li><li><i className="bmi-key-highest" aria-hidden="true"></i><span>Highest range<br/><small>35+</small></span></li></ul></div><small>This estimate updates as you type. BMI is a screening measure, not a diagnosis. A licensed provider considers your complete health history.</small></div>
