...
export function WegovyPillExperience(){return <main className="pill-page">
  ...
  <section className="pill-intro"><div><p className="pill-kicker">Meet Wegovy® Pill</p><h2>A familiar ingredient. A new daily format.</h2></div><div><p>Wegovy® Pill contains semaglutide, a GLP-1 receptor agonist. It is used with reduced-calorie nutrition and increased physical activity for chronic weight management in eligible patients.</p><Link href={MAIN_GLP_INTAKE_URL}>Start the online assessment →</Link></div></section>
  ...
  <section className="pill-closing"><div className="pill-closing-ring" aria-hidden="true"></div><img src="/novo-pills-clean.png" alt="Wegovy tablets"/><div><p className="pill-kicker">Your next step</p><h2>See whether Wegovy® Pill may fit your care plan.</h2><Link className="pill-primary" href={MAIN_GLP_INTAKE_URL}>Start the assessment <span>→</span></Link><small>A prescription is not guaranteed.</small></div></section>
  <SiteFooter/>
</main>}
