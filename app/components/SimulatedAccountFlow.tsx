...
export function DemoAccountDashboard(){
  ...
  const stages=[
    {label:"Program selected",title:"Start the assessment",copy:"Choose a program and complete the fictional assessment questions.",action:"Start simulated assessment",href:"/eligibility"},
