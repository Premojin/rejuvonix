...
const baseProtocols: BaseProtocolItem[] = [
  ...
  {slug:"glp-1-microdose",name:"GLP-1 Microdose",sourceCategory:"Metabolic / body composition",goals:["weight-loss"],summary:"Lower-dose GLP-1 pathway education for provider review in appropriate weight-management contexts.",discussionPoints:["Personal health history and treatment goals","Medication history and contraindication screening","Whether this pathway is clinically appropriate and legally available"],regulatoryNote:"This educational listing does not establish clinical availability, dosing or an FDA-approved indication. An independent licensed provider determines whether any treatment pathway is appropriate.",compoundedContext:"possible"},
...
const protocolPresentation: Record<string, {priceLabel: string; image: string; imageAlt: string}> = {
  semaglutide: {priceLabel: "Current pricing confirmed in assessment", image: "/v6/semaglutide-2.5mg-ml.png", imageAlt: "Semaglutide compounded medication vial"},
  tirzepatide: {priceLabel: "Current pricing confirmed in assessment", image: "/v6/tirzepatide-5mg-0.5ml.png", imageAlt: "Tirzepatide compounded medication vial"},
  "glp-1-microdose": {priceLabel: "Current pricing confirmed in assessment", image: "/v6/glp1-microdose-500mcg-ml.png", imageAlt: "GLP-1 Microdose compounded medication vial"},
...
export const protocols: ProtocolItem[] = baseProtocols.map((protocol) => ({
  ...protocol,
  intakeType: ["semaglutide","tirzepatide","glp-1-microdose"].includes(protocol.slug) ? "glp" : "peptide",
