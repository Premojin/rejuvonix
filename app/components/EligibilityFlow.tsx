...
export const programConfigs = {
  ...
  "skin-restoration":{name:"Skin Restoration",kicker:"Care for your skin goals",headline:"Begin with the changes that matter to you.",description:"This starting point helps organize your priorities before any provider-led clinical assessment.",questions:[
