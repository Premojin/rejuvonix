...
export function ProductPage({product}: {product: Product}) {
  ...
  return <main className={`detail-page product-experience product-${product.slug}`}>
    ...
    <section className={`detail-closing ${compounded?"compounded-closing":""}`}>{compounded&&<div className="compounded-closing-graphic" aria-hidden="true"><span><img src="/v6/compounded-medication-generic.png" alt=""/></span><span><img src="/v6/compounded-medication-generic.png" alt=""/></span></div>}<p className="detail-kicker">Get started</p><h2>{compounded?"Find out which compounded option may fit your care plan.":"Find out which option may fit your health needs."}</h2><Link className="detail-primary" href="/eligibility/weight-loss">Start the assessment</Link><small>A prescription is not guaranteed.</small></section>
    <SiteFooter />
  </main>;
}
